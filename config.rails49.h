 ...
 * workflow copies it to config.h and appends WIFI_PASSWORD, which is held as a
 * repository secret because this repository is public. Building by hand needs
 * the same append, see docs/RELEASE.md.
 */
...
// the layout server reaches it over USB. WIFI_PASSWORD is the AP's password.
